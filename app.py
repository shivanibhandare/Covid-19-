import dash_core_components as dcc # use this part to run dash board
import numpy as np
import pandas as pd
...
#to create the style sheet used css boat scrap
...
#created the layout by using the html
app.layout=html.Div([
...
#call the python advance fubction and created the function
...
def generate_graph(my_dropdowm):

    piechart = px.pie(data_frame= patients,names=my_dropdowm,hole=0.3)
    return(piechart)
